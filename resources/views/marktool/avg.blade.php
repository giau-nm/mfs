...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Chi tiết chấm điểm cuộc gọi của AVG.</h1>
    </section>
    <div class="content">
            ...
            <div class="box-body">
                    <div class="grid">
                        ...
                        <p>
                           ...
                           <a href="/file/avg_6460563.xls" type="button" class="btn btn-success">Xuất file Excel</a>
                           <button type="button" class="btn btn-success">Chấm điểm cuộc gọi mới</button> 
                        </p>
                        <br />
